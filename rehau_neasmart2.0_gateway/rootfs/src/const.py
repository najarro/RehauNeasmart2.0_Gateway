...
DEFAULT_SLAVE_ID = 240
DEFAULT_SLAVE_IDS = [240, 241]
...
DEFAULT_REGISTERS_STALE_AFTER_SECONDS = 180
DEFAULT_PERSIST_COMMAND_REGISTERS = False
DEFAULT_COMMAND_SYNC_TIMEOUT_SECONDS = 30
